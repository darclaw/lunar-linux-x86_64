...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BLDSHARED': 'gcc -pthread -shared -s -z relro -z now  -s -z relro -z now',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
           '-O2 -march=x86-64 -pipe  -O2 -march=x86-64 -pipe -O2 -march=x86-64 '
           '-pipe',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-O2 -march=x86-64 -pipe',
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            '-Wno-unused-parameter '
                            '-Wno-missing-field-initializers '
                            '-Wno-cast-function-type',
 'CONFIGURE_CPPFLAGS': '-D_FORTIFY_SOURCE=2',
 'CONFIGURE_LDFLAGS': '-s -z relro -z now',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--build=x86_64-pc-linux-gnu' '--prefix=/usr' "
                "'--sysconfdir=/etc' '--localstatedir=/var' "
                "'--infodir=/usr/share/info' '--mandir=/usr/share/man' "
                "'--enable-shared' '--enable-ipv6' '--with-threads' "
                "'--with-system-ffi' '--with-system-expat' "
                "'--with-computed-gotos' '--without-ensurepip' "
                "'build_alias=x86_64-pc-linux-gnu' 'CC=gcc' 'CFLAGS= -O2 "
                "-march=x86-64 -pipe' 'LDFLAGS= -s -z relro -z now' 'CPPFLAGS= "
                "-D_FORTIFY_SOURCE=2' 'CPP=cpp'",
 ...
 'LDFLAGS': '-s -z relro -z now  -s -z relro -z now',
 'LDFLAGS_NODIST': '',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.6m.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -s -z relro -z now  -s -z relro -z now',
 'LDVERSION': '3.6m',
 'LIBC': '',
 ...
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
              '-O2 -march=x86-64 -pipe  -O2 -march=x86-64 -pipe -O2 '
              '-march=x86-64 -pipe',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   '-Wall -O2 -march=x86-64 -pipe  -O2 -march=x86-64 -pipe -O2 '
                   '-march=x86-64 -pipe -std=c99 -Wextra -Wno-unused-result '
                   '-Wno-unused-parameter -Wno-missing-field-initializers '
                   '-Wno-cast-function-type -I. -I./Include '
                   '-D_FORTIFY_SOURCE=2  -D_FORTIFY_SOURCE=2 -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-s -z relro -z now  -s -z relro -z now',
 'PY_CPPFLAGS': '-I. -I./Include -D_FORTIFY_SOURCE=2  -D_FORTIFY_SOURCE=2',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-s -z relro -z now  -s -z relro -z now',
 'PY_LDFLAGS_NODIST': '',
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 'Py_HASH_ALGORITHM': 0,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/usr/src/Python-3.6.8',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/usr/src/Python-3.6.8 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/usr/src/Python-3.6.8 ./python '
